...
import com.example.adminwavesoffoods.databinding.ActivityFeedbackBinding
...
class Feedback : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val customerNames = listOf("John Doe", "Jane Smith", "Michael Johnson")
        ...
        val adapter = FeedbackAdapter(customerNames, feedbackList)
